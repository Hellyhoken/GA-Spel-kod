...
namespace Fragsurf.Movement {
    public class SurfPhysics {
        ...
        public static void ResolveCollisions (Collider collider, ref Vector3 origin, ref Vector3 velocity, float rigidbodyPushForce, Vector3 centrumOffset, float velocityMultiplier = 1f, float stepOffset = 0f, ISurfControllable surfer = null) {

			Vector3 colliderCentrum = origin + centrumOffset;
            ...
            if (collider is CapsuleCollider) {
                ...
                numOverlaps = Physics.OverlapBoxNonAlloc (colliderCentrum, collider.bounds.extents, _colliders,
            ...
            for (int i = 0; i < numOverlaps; i++) {
                ...
                if (Physics.ComputePenetration (collider, colliderCentrum,
